...
const allMagazines = [
  '​the winnow', 'fifth wheel press', 'West Trade Review',
  ...
  'Claw & Blossom', 'indigo lit', 'The Augment Review', 'warning lines',
  ...
  'Hippocampus Magazine', 'Five South', 'ANMLY', 'beestung',
  ...
  'Memorious', 'Hot Pink', 'Papeachu Press', 'Heart of Flesh Literary Journal',
  ...
  'Zoetic Press', 'Inertia teens', 'bs/ws', 'Expo Review Lit', 'Cordella Press',
  'Speculative Nonfiction', 'Cutleaf Journal', 'Flashback Fiction', 'LPReview',
  'A Velvet Giant', 'Stone of Madness', 'Free Library of the Internet Void',
